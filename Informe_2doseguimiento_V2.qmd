...
-   Evaluar la relación entre las variables ambientales evaluadas en los valles profundos del río Moldavia.

-   Determinar diferencias en las condiciones ambientales de los tipos de vegetación presentes en los valles profundos del río Moldavia.
...
-   **Ho**: No existen relaciones entre las variables ambientales evaluadas en los valles profundos del río Moldavia.

-   **Ha**: Existen relaciones entre las variables ambientales evaluadas en los valles profundos del río Moldavia.
...
En el correlograma presentado en la @fig-fig2 observamos los grados de correlación entre las variables topográficas y topológicas con las variables ambientales medidas de manera indirecta con el promedio de indices de hellinberg en cada parcela. Los seis indices se relacionan significativamente con la profundidad del suelo , la luz, la temperatura y la continentalidad se relacionan negativamente, mientras que la humedad, reactividad y nutrientes positivamente, pero sin alcanzar un indice de correlación siquiera moderado. Cinco de los indices se relacionan de manera significativa con las variables de orientación y carga calorifica de las cuales la luz, la temperatura y la continentalidad se relacionan positivamente, mientras que la humedad y los nutrientes se relacionan negativamente. En cuanto a los tipos de suelos, los esqueleticos y fluvisoles se relacionan de manera significativa y positiva con la humedad, reactividad y nutrientes, mientras que los liticos mostraría una relación negativa significativa con estos indices, pero igualmente sin alcanzar una correlación moderada. El tipo de suelo Cambisol presenta una relación negativa significativa, sin embargo la correlación es bastante debil al igual que con el resto de las variables.
...
### -Variación ambiental entre las parcelas según los tipos de suelo en los valles profundos del río de Moldavia (Análisis por componentes principales)
...
La @fig-fig4 nos presenta los resultados del análisis por componentes principales, en la que variación se da en función de tres conjuntos de variables, siendo uno conformado por la orientación sur-sureste, la temperatura, la continentalidad , la carga calorifica y la luz, los cuales tienen direcciones casi ortogonales con el resto de variables. Otro conjunto estaría conformado por la pendiente, la superficie en pendiente, la superficie en isohipsas y la elevación, en dirección contraria a este conjunto por lo que presuntamente tendrían una relación negativa con estas variables se encuentra el tercer grupo de variables, conformado por la humedad, reactividad , nutrientes del suelo, el pH, la temperatura y la continentalidad del clima. En cuanto a los factores de agrupación se podría interpretar que los suelos con condición de fluvisol, esqueleticos y liticos tendrían cierta asociación de variables ambientales con su incidencia, sin embargo se requieren análisis exploratorios confirmatorios ya que el porcentaje de variación acumulado entre los dos componentes principales podría no ser suficiente para una correcta interpretación.
