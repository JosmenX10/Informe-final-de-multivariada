...
-   Evaluar la influencia de las variables ambientales en la variación de la composición de las comunidades de plantas en los valles profundos del río Moldavia.
...
-   **Ho**: La topografía y la topología no influyen en la variación de la composición de los comunidades vegetales en los valles profundos del río Moldavia.
...
## **2.** Determinar las diferencias entre los tipos de comunidades vegetales de los valles profundos del río Moldavia en función de sus condiciones ambientales, riqueza, cobertura vegetal y composición.

### **-Diferencias en la altitud y orientación de las parcelas de acuerdo a los tipos de comunidades vegetales**
...
Se convierten los porcentajes de cobertura de cada especie a valores en metros cuadrados (\$m\^2\$) para, posteriormente, seleccionar las 15 especies con mayor cobertura. Luego, se determina cuánto contribuye en cobertura cada una de estas especies en los diferentes tipos de comunidades de plantas.
...
f1 <- ggplot(datos_g,aes(x = Luz, y = Abiealb1)) + 
  ...
  scale_y_continuous(limits = c(0,75)) +
    labs(x = "Luz", y = "Porcentaje de cobertura de Abies alba")
