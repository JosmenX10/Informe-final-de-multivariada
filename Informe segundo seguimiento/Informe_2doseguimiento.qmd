...
```{r, message=FALSE,warning=FALSE, fig.ncol=2}
#| label: fig-fig2 
#| fig-cap: Relación de las variables de orientación y capacidad calorífica. A) Relación entre orientación Sur con la orientación Sur-Sureste. B)Relación entre el indice de capacidad calorífica.
...
include_graphics("C:\\Users\\Asus\\Desktop\\Analisis multivariado\\Informe-final-de-multivariada\\Graficos\\Explicaciones\\Orientación.png") 
...
```{r,warning=FALSE,message=FALSE}
#| label: fig-fig4 
#| fig-cap: "Comparación de las altitudes entre distintos tipos de superficie en las parcelas según el eje a favor de la pendiente."
...
g3 = ggplot(datos_env,aes(x=factor(Superficie.PD),y=Elevación)) + 
  ...
  labs( x = "Tipos de relieve a lo largo de la pendiente", y = "Elevación (M.S.N.M)")
...
```{r}
#| label: fig-fig5 
#| fig-cap: "Comparación de las altitudes para las parcelas en suelos líticos y no líticos."
...
```{r, warning=FALSE,message=FALSE}
#| label: fig-fig6 
#| fig-cap: "Frecuencias de las parcelas con distintos tipos de superficie según el eje a favor de la pendiente y si presenta o no el tipo de suelo lítico."
...
```{r, message=FALSE,warning=FALSE}
#| label: fig-fig15 
#| fig-cap: "Relación entre la cobertura de la especie Abies alba con respecto a la variable de Luz." 
